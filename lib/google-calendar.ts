...
function findLeaveEventIds(config: GoogleCalendarConfig, accessToken: string, leaveRequestId: string) {
  return findEventIdsByPrivateProperty(config, accessToken, 'leaveRequestId', leaveRequestId)
}
