                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-border bg-surface/50">
                                        ...
                                        <th className="px-4 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">Expected</th>
            ...
            >
                {updateModal.ticket && (
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-1.5">
                                Expected Resolution Date {(newStatus === 'SOLUTION' || newStatus === 'RESOLVED') && <span className="text-red-500">*</span>}
                            </label>
                            <input
                                type="date"
