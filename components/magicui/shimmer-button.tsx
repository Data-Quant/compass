    ...
    return (
      <button
        ...
        className={cn(
          ...
          "shadow-glow-primary hover:shadow-glow-lg",
          className
        )}
        ref={ref}
        {...props}
      >
        ...
        <div
          className={cn(
            ...
            "group-hover:[background:var(--bg)] group-hover:shadow-[inset_0_-6px_10px_#ffffff3f]",
            "group-active:[background:var(--bg)]"
          )}
        />
        ...
        {/* content */}
        <span className="z-10 flex items-center gap-2 whitespace-nowrap text-sm font-semibold">
          {children}
        </span>
      </button>
    );
